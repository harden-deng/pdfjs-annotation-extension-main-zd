...
const PDFViewerApplication = {
  ...
  //   originalUrl?: string;   // 原始文件名（用于显示）
  //   data?: ArrayBuffer;    // PDF 文件的二进制数据
  //   range?: any;           // 范围请求参数
  //   httpHeaders?: any;     // HTTP 请求头
  //   withCredentials?: boolean; // 是否发送凭据
       // ... 其他 PDF.js 支持的参数
  // }
  async open(args) {
    console.log("要打开pdf了01",args)
    if (this.pdfLoadingTask) {
      await this.close();
    }
    console.log("要打开pdf了02",args)
